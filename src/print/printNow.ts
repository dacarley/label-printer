...
import { setPageSizeInches, clearPageSize } from "./pageStyle";
...
export function createPrintNow(deps: PrintDeps) {
  ...
  return function printNow() {
    ...
    try { renderPrintRoot(deps.printRoot, snapshot); } catch {}
